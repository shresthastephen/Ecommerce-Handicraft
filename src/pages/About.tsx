        ...
        <div className="container mx-auto px-4 max-w-6xl grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Our collection includes statues crafted with spiritual accuracy
              and artistic detail. Each statue is carefully shaped to reflect
              authentic expressions, sacred mudras, and traditional symbolism.
            </p>
